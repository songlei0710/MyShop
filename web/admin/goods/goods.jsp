...
<body data-spy="scroll" data-target=".subnav" data-offset-top="40">
  ...
  <div id="navigation" class="navbar">
      <div class="navbar-innert">
          ...
          <a class="brand" href="#">商品信息管理 </a>
          <a class="brand2">编辑商品信息 </a>
      </div>
  </div>
          ...
          <div id="mainlogic" class="span10">
              ...
              <div class="form-actions">
                  ...
                  <div id="gat" style="display: none; border: 1px solid #E3E3E3; padding: 10px; margin-bottom: 10px;">
                      ...
                      <div class="form-inline">
                          <span class="label label-required">属性选择区:</span>
                          <select id="gatarea" name="gatarea"></select>
                      </div>
                  </div>
                  ...
                  <div id="goodscategory" style="display: none;" class="form-inline">
                      <span class="label label-required">商品所在分类: </span> <span id="shownname"></span>
                      <!-- 显示顶级分类一级分类名称 -->
                      ...
                      <input type="hidden" id="hidnavid" value=""/>
                      <input type="hidden" id="hidnname" value=""/>
                      <input type="hidden" id="hidltypeid" value=""/>
                      <input type="hidden" id="hidlname" value=""/>
                      <input type="hidden" id="hidstypeid" value=""/>
                      <input type="hidden" id="hidsname" value=""/>
                  </div>
                  ...
                  <div class="form-inline">
                      <span class="label label-required">商品名称:</span>
                      <input type="text" id="goodsname" name="goodsname" class="medium" />
                      <span class="label label-info">商品名称会根据货品规格信息智能变化</span>
                  </div>
                  <div class="form-inline">
                      <span class="label label-required">商品编码:</span>
                      <input type="text" id="usersetnum" name="usersetnum" class="small" />
                  ...
                  <div class="form-inline">
                      <span class="label label-required">商品积分:</span>
