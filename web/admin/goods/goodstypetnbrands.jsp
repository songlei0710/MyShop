...
<div id="navigation" class="navbar">
  <div class="navbar-innert">
    ...
    <a class="brand" href="#">商品品牌类型及参数设置 </a>
    <a class="brand2">编辑商品品牌类型及参数 </a>
  </div>
</div>
  ...
  <div class="row-fluid">
    ...
    <div id="mainlogic" class="span10">
      <div class="alert alert-success">
        ...
        <strong>说明</strong>请根据需要编辑商品品牌类型
      </div>
      ...
      <form id="goodstypetnform">
        <div class="form-actions">
          <div class="form-inline">
            <span class="label label-required">商品品牌类型名称: </span> <input
                  id="brandName" name="brandName" type="text" value="" class="small" /> <span
                  class="label label-info">给你销售的商品品牌定义一个类型，例如手机</span>
          </div>
          <div class="form-inline">
            <label class="label label-submit"></label>
            <input type="hidden" id="hidgoodsTypeBrandTid" name="hidgoodsTypeBrandTid" value="" />
