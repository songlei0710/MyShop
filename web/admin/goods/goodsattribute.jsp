        ...
        <div id="mainlogic" class="span10">
            ...
            <form id="goodsattributeform">
                <div class="form-actions">
                    ...
                    <div class="form-inline">
                        <span class="label label-required">是否支持属性检索</span>
                        <input type="radio" name="isSearch" value="1" checked="checked"/>是
                        <input type="radio" name="isSearch" value="0"/>否
                    </div>
                    <div class="form-inline" >
                        <span class="label label-required">是否开启属性关联</span>
                        <input type="radio" name="isSameToLink" value="1" checked="checked"/>是
                        <input type="radio" name="isSameToLink" value="0"/>否
                    </div>
                    
                    <div class="form-inline">
                        <label class="label label-submit"></label>
                        <input type="hidden" id="hidgoodSatTributeId" name="hidgoodSatTributeId" value="" />
